...
<head>
    ...
    <!-- Custom Meta Data -->
    <link rel="icon" type="image/png" href="https://apigamble.com/images/icon_white_min.png">
        ...
        <div v-cloak class="flex min-h-screen">
            ...
            <div class="flex-none pt-header min-h-screen w-sidebar bg-grad-sidebar px-6">
                <a href="{{ \Laravel\Nova\Nova::path() }}">
                    <div class="absolute pin-t pin-l pin-r bg-logo flex items-center w-sidebar h-header px-6 text-white" style="justify-content: center;">
                    <img style="width: 95px; margin-top: 30px;" src="https://apigamble.com/images/icon_white.png">
                    </div>
                </a>
