...
class CurrencyPart extends Partition
{
    /**
    ...
    public function calculate(NovaRequest $request)
    {
		if($request->user()->access == 'administrator') {
			return $this->count($request, withdrawAndDeposit::class, 'currency');
		} else {
			...
			return $this->count($request, withdrawAndDeposit::whereIn('operator', $apioperator), 'currency');
		}
    }
